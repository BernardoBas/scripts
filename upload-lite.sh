...
sftp bernardobas@frs.sourceforge.net:/home/pfs/project/lg-g6/Nightlies/US997/ <<< $'put *.*'
...
sftp bernardobas@frs.sourceforge.net:/home/pfs/project/lg-g6/Nightlies/H870/ <<< $'put *.*'
